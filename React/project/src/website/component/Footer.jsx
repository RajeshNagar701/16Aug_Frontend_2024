          ...
          <div className="row">
            ...
            <div className="col-md-4 pt-5">
              ...
              <ul className="list-unstyled text-light footer-link-list">
                ...
                <li><NavLink className="text-decoration-none" to="/about">About Us</NavLink></li>
                <li><NavLink className="text-decoration-none" to="/location">Shop Locations</NavLink></li>
                <li><NavLink className="text-decoration-none" to="/faq">FAQs</NavLink></li>
                <li><NavLink className="text-decoration-none" to="/contact">Contact</NavLink></li>
              </ul>
            </div>
          </div>
